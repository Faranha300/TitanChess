...
game_over = (pg.image.load('game_over.jpg'), pg.image.load('game_over_branco.jpg'), pg.image.load('game_over_vermelho.jpg'))
bck_gr = pg.image.load('Game_background.png')
begin = pg.image.load('tela_inicial.png')
win = (pg.image.load('win_base.png'), pg.image.load('win_branco.png'), pg.image.load('win_vermelho.png'))
